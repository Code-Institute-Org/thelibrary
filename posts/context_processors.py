...
def notifications(request):
    if request.user.is_authenticated:
        num_author_posts_in_review = Post.objects.filter(
        ...
        context = {
            'num_author_posts_in_review': num_author_posts_in_review,
            'num_posts_to_review': num_posts_to_review,
            'total_notifications': num_author_posts_in_review + num_posts_to_review,
        }
